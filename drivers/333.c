...
/* Private define -------------------------------------------------------*/
#define NAND_FLASH_START_ADDR     ((uint32_t)0x80000000) /* Bank3 */
#define NAND_BANK     (0x80000000)
...
* Attention		 : None
*******************************************************************************/
void rt_nandflash_hw_ini8t(void)
{
    uint16_t index;
    ...
    FSMC_NAND_WritePage(TxBuffer, WriteReadAddr, 1);

    /* Read back the written data */
    FSMC_NAND_ReadPage(RxBuffer, WriteReadAddr, 1);
