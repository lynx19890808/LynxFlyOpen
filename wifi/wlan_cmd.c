...
FINSH_FUNCTION_EXPORT(wlan_pm_exit, exit PM mode);
...
{
	extern WlanCard cardinfo;
	wlan_cmd_802_11_rssi(&cardinfo);
	return 0;
}
FINSH_FUNCTION_EXPORT(wlan_rssi, get rssi information);
...
#include <finsh.h>
int wlan_log_get(void)
{
	extern WlanCard cardinfo;
	wlan_cmd_802_11_get_log(&cardinfo);
	return 0;
}
FINSH_FUNCTION_EXPORT(wlan_log_get, get wlan log);
