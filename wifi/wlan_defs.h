...
#define MRVDRV_NUM_OF_CMD_BUFFER        1
#define MRVDRV_SIZE_OF_CMD_BUFFER       (1 * 1024)
#define MRVDRV_MAX_BSSID_LIST		32
#define MRVDRV_TIMER_10S		100000
...
/*New */
#define WLANPhase1InitDone (0x01)
#define WLANSPIInitDone (0x02)
#define WLANCareProbeDone (0x03)
#define WLANFWDownLoadDone (0x04)

#define WLANPhase2InitDone  (0x05)
#define WLANGBusConfigDone (0x06)
#define WLANGGetMacDone (0x07)
#define WLANPhase3InitDone (0x08)
/*end*/
#endif
